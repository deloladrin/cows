...
public class MainActivity extends DatabaseActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ResourceTemplate resource_block_wood = new ResourceTemplate(this.database, 0, "Wooden Block", ResourceType.FINGER_INVERTED, 1, true, new DatabaseBitmap(this, R.drawable.resource_block_wood), new DatabaseBitmap(this, R.drawable.resource_block_wood)); resource_block_wood.insert();
        ResourceTemplate resource_block_wood_xxl = new ResourceTemplate(this.database, 0, "Wooden Block", ResourceType.FINGER_INVERTED, 1, true, new DatabaseBitmap(this, R.drawable.resource_block_wood_xxl), new DatabaseBitmap(this, R.drawable.resource_block_wood_xxl)); resource_block_wood_xxl.insert();
        ResourceTemplate resource_block_tp = new ResourceTemplate(this.database, 0, "TP Block", ResourceType.FINGER_INVERTED, 1, true, new DatabaseBitmap(this, R.drawable.resource_block_tp), new DatabaseBitmap(this, R.drawable.resource_block_tp)); resource_block_tp.insert();
        ResourceTemplate resource_block_tp_xxl = new ResourceTemplate(this.database, 0, "TP Block XXL", ResourceType.FINGER_INVERTED, 1, true, new DatabaseBitmap(this, R.drawable.resource_block_tp_xxl), new DatabaseBitmap(this, R.drawable.resource_block_tp_xxl)); resource_block_tp_xxl.insert();
        ResourceTemplate resource_block_iron_half = new ResourceTemplate(this.database, 0, "½ Iron Block", ResourceType.FINGER_INVERTED, 1, true, new DatabaseBitmap(this, R.drawable.resource_block_iron_half), new DatabaseBitmap(this, R.drawable.resource_block_iron_half)); resource_block_iron_half.insert();
        ResourceTemplate resource_block_iron = new ResourceTemplate(this.database, 0, "Iron Block", ResourceType.HOOF, 1, true, new DatabaseBitmap(this, R.drawable.resource_block_iron), new DatabaseBitmap(this, R.drawable.resource_block_iron)); resource_block_iron.insert();
        ResourceTemplate resource_synulox = new ResourceTemplate(this.database, 0, "Synulox", ResourceType.HOOF, 2, false, new DatabaseBitmap(this, R.drawable.resource_synulox), new DatabaseBitmap(this, R.drawable.resource_synulox)); resource_synulox.insert();
        ResourceTemplate resource_synulox_2x = new ResourceTemplate(this.database, 0, "2x Synulox", ResourceType.HOOF, 2, false, new DatabaseBitmap(this, R.drawable.resource_synulox_2x), new DatabaseBitmap(this, R.drawable.resource_synulox_2x)); resource_synulox_2x.insert();
